    ...
    color: <?=$rowOpt['text_color']?> !important;
                                                ...
                                                <div class="testimonial-text">
                                                    <p>
                                                      <?php if(!empty($item["project"])) {?>
                                                         <div style="font-weight:bold; font-size:14px;color:#fff"><?= $item["project"]?></div> 
                                                       <?php }?>
                                                       <?php echo $mWidgetC->custom_limit(nl2br($item["descrip"]), $rowOpt['num_car'], $linkReviews='/reviews'); ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="cell-xs-12 text-center ">
                            <a style="margin-bottom: 20px;" href="<?=$page_review?>" class="btn btn-warning" target="<?=isset($target_review)?$target_review:''?>"><i class="fa fa-plus"></i> More Reviews</a>
                            <a style="margin-bottom: 20px; margin-top: 0px;" href="<?=$page_write?>" class="btn btn-warning" target="<?=isset($target_write)?$target_write:''?>" title="Write a Review">
